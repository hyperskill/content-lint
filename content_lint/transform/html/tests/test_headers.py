...
def test_remove_bold_text(settings: Settings) -> None:
    text = (
...
def test_replace_secondary_header(settings: Settings) -> None:
...
def test_replace_secondary_header_7(settings: Settings) -> None:
...
def test_add_header_id(settings: Settings) -> None:
...
def test_fix_doubled_header_id(settings: Settings) -> None:
...
def test_replace_exist_header_id(settings: Settings) -> None:
...
def test_replace_marked_list_inside_header(settings: Settings) -> None:
...
def test_remove_empty_headers(settings: Settings) -> None:
