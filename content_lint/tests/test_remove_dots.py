...
def test_remove_dots_in_the_string() -> None:
    assert remove_dots_in_the_string('test.....') == 'test.....'
    assert remove_dots_in_the_string('test....') == 'test...'
    assert remove_dots_in_the_string('test...') == 'test...'
    assert remove_dots_in_the_string('test..') == 'test.'
    assert remove_dots_in_the_string('.') == '.'
    assert remove_dots_in_the_string(r'test\.') == r'test\.'
    assert remove_dots_in_the_string('test.') == 'test'
    assert remove_dots_in_the_string('test') == 'test'
    assert (
        remove_dots_in_the_string(
    ...
    assert remove_dots_in_the_string('') == ''
    assert (
        remove_dots_in_the_string('head [OPTION]... [FILE LIST]...')
        == 'head [OPTION]... [FILE LIST]...'
    )


def test_remove_dots() -> None:
    step_data = StepData(
        step_index=0,
        block_name='block',
        text='text',
...
def test_remove_dots_no_options_key() -> None:
    step_block = StepData(
        step_index=0,
